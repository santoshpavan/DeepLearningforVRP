...
class VRPEnvironment:
    ...
    #failing_task_penalty = 500 #trucks fail to complete the task
    completion_reward = 100 #trucks complete the task
    # exploration settings
    epsilon = 1
    epsilon_decay = 0.999
    min_epsilon = 0.001
    no_of_episodes = 20_000
    ...
    def __init__(self):
        ...
        self.node_demands = self.problem.demands
...
class DQNAgent:
    ...
    def train(self, terminal_state, step):
        ...
        self.main_model.fit(np.array(X)/255, np.array(y), batch_size=min_training_length, verbose=0, shuffle=False)
